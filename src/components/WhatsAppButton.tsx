...
export default function WhatsAppButton() {
  return (
    <a
    href="https://wa.me/919686984930"
    target="_blank"
    rel="noopener noreferrer"
    className="fixed bottom-6 right-6 bg-neutral-900 rounded-full p-2 shadow-lg hover:bg-neutral-800 transition-all duration-300 z-50"
